  ...
  return (
    <div className="min-h-screen bg-gbl-navy-950 py-8 sm:py-12 px-3 sm:px-6 lg:px-8 text-slate-100">
      <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
        ...
        {/* Filters Bar */}
        <div className="flex flex-wrap items-center justify-between gap-3 bg-gbl-navy-900 p-3.5 rounded-2xl border border-gbl-navy-800">
          <div className="flex flex-wrap items-center gap-2">
            {/* Pool Filter */}
            <div className="flex items-center gap-1">
              <span className="text-[10px] uppercase font-bold text-slate-400 pl-1 flex items-center gap-1">
            ...
            {/* Round Filter */}
            {rounds.length > 0 && (
              <div className="flex items-center gap-1 pl-2 border-l border-gbl-navy-800">
                <span className="text-[10px] uppercase font-bold text-slate-400 pl-1">Round:</span>
                <button
          ...
          {filteredTies.length > 0 && (
            <div className="flex items-center gap-2 text-xs">
              <button
                onClick={expandAll}
                className="px-2.5 py-1 rounded-lg bg-gbl-navy-950 hover:bg-gbl-navy-800 text-slate-300 hover:text-white border border-gbl-navy-800"
              >
                Expand All
              </button>
              <button
                  ...
                  <div className="p-5 sm:p-6 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 bg-gradient-to-r from-gbl-navy-900 via-gbl-navy-950/40 to-gbl-navy-900">
                    ...
                    <div className="flex items-center gap-4 sm:gap-8 flex-1 justify-center w-full lg:w-auto">
                      ...
                      <div className="flex items-center gap-3 text-right flex-1 justify-end min-w-0">
                        ...
                        {team1?.logo_url ? (
                          <div className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-700 p-0.5 flex items-center justify-center overflow-hidden shrink-0">
                    ...
                    <div className="flex items-center gap-2 self-end lg:self-center shrink-0">
                      <button
                        ...
                        className="px-3.5 py-2 rounded-xl bg-gbl-navy-800 hover:bg-gbl-navy-700 text-slate-200 hover:text-white text-xs font-bold flex items-center gap-1.5 transition-colors border border-gbl-navy-700"
                      >
                        <span>{isExpanded ? 'Hide Category Matches' : 'View 6 Category Matches'}</span>
